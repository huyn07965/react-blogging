...
const EditReportStyle = styled.div`
  width: 100%;
  .report {
    width: 50%;
    margin: -20px auto;
...
const EditReport = () => {
  ...
  console.log("data", checkReasonOne);

  const handleUpdateReport = async () => {
    await axios
      .put(baseUrl.updateReport + idReport, { status: 1 })
      .then(() => {
  ...
  useEffect(() => {
    document.title = "Edit Report Page";
  });
  return (
    <EditReportStyle showContentEn={showContentEn}>
